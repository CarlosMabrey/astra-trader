...
class BirdeyeClient:
    ...
    def _get(self, path: str, params: dict[str, object]) -> dict:
        ...
        req = urllib.request.Request(
            url,
            headers={"X-API-KEY": self.api_key, "x-chain": self.chain},
        )
    ...
    def _normalize_trade(wallet: str, item: dict) -> WalletTrade:
        # Birdeye response fields can vary by route/protocol; fail loudly rather than
        # inventing values. This parser is deliberately conservative.
